...
namespace semifinishAdmin.Controllers
{
    public class siixsem_semifinish_tController : Controller
    {
        ...
        // GET: siixsem_semifinish_t/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: siixsem_semifinish_t/Create
        ...
        // GET: siixsem_semifinish_t/Edit/5
        ...
        // POST: siixsem_semifinish_t/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: siixsem_semifinish_t/Delete/5
        ...
        // POST: siixsem_semifinish_t/Delete/5
